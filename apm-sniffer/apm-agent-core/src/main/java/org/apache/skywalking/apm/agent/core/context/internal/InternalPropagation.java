...
public abstract class InternalPropagation {
     ...
     */
    public abstract TraceContext newTraceContext(int flags, long traceIdHigh, long traceId,
        long localRootId, long parentId, long spanId, List<Object> extra);

    /** {@linkplain TraceContext} is immutable so you need to read the result */
