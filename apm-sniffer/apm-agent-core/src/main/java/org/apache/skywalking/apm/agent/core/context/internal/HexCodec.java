...
public final class HexCodec {
     ...
     */
    public static long lenientLowerHexToUnsignedLong(CharSequence lowerHex, int index,
        int endIndex) {
        long result = 0;
    ...
    private static NumberFormatException isntLowerHexLong(CharSequence lowerHex) {
