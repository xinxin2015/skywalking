...
public class SamplingFlags {
    ...
    static {
        InternalPropagation.instance = new InternalPropagation() {
            ...
            @Override
            public TraceContext withExtra(TraceContext context, List<Object> immutableExtra) {
                return context.withExtra(immutableExtra);
            }
    ...
    private static final SamplingFlags
