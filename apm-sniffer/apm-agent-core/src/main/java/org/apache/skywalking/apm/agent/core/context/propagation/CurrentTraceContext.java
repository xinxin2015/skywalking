...
import org.apache.skywalking.apm.agent.core.context.internal.WrappingExecutorService;
...
public abstract class CurrentTraceContext {
    ...
    public static abstract class Builder {
        ...
        public Builder addScopeDecorator(ScopeDecorator scopeDecorator) {
            Assert.notNull(scopeDecorator, "scopeDecorator can not be null");
    ...
    private final List<ScopeDecorator> scopeDecorators;
    ...
    public Executor executor(final Executor delegate) {
        class CurrentTraceContextExecutor implements Executor {
            ...
            public void execute(Runnable command) {
                delegate.execute(CurrentTraceContext.this.wrap(command));
            }
        }
